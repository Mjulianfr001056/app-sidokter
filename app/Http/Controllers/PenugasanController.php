...
class PenugasanController extends Controller implements RestControllerInterface
{
    ...
    //memberikan penugasan kepada mitra
    ...
    public function editMitra($id): View
    {
        $detail_tugas = Penugasan::getById($id);
    ...
    public function editOrganik($id): View
    {
        $detail_tugas = Penugasan::getById($id);
        $pilihan_pelaksana = Organik::all(['id', 'nama']);
        //$pilihan_pemberi_tugas = Pegawai::all(['id', 'nama']);
        $pilihan_status = self::getStatusKegiatan();
