        ...
        <div class="max-w-[78vw] flex flex-col justify-center pb-12 ">
            <div class="relative overflow-x-auto">
                <table class="table-custom">
                    <thead>
                    <tr>
                        <th scope="col" rowspan="2" class="w-12">No</th>
                        <th scope="col" rowspan="2" class="w-64">Nama</th>
                        <th scope="col" colspan="3" class="text-center">Alamat</th> <!-- Alamat spans 3 columns -->
                        <th scope="col" rowspan="2" class="w-24">Kontak</th>
                        <th scope="col" rowspan="2" class="w-64">Aksi</th>
                    </tr>
                    <tr>
                        <th scope="col" class="w-24">Kecamatan</th>
                        <th scope="col" class="w-24">Kelurahan</th>
                    ...
                    <tr class="tr-border-b">
                        ...
                        <td class="px-6 py-4">Kelurahan</td>
