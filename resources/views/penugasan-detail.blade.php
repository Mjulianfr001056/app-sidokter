                            ...
                            <table class="table-custom">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->nama }}</td>
                                        <td class="text-center">{{ $penugasanPegawai->target }}</td>
                                        <td class="text-center">{{ $penugasanPegawai->terlaksana }}</td>
                                        <td class="text-center">
                                            <a href="'{{$item->nip}}'" class="button bg-blue-500 py-1 px-2 text-white font-md rounded-md">Detail</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @else
                        ...
                        <table class="table-custom">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->nama }}</td>
                                    <td class="text-end">{{ $item->pendapatan }}</td>
                                    <td class="text-end">{{ $item->pendapatan }}</td>
                                    <td class="text-end">{{ $item->pendapatan }}</td>
                                ...
                                <!-- Menampilkan link navigasi paginasi -->
                                <tr>
                                    <td colspan="7" class="text-center">
                                        {{ $mitra->links() }} <!-- Link paginasi otomatis -->
                                    </td>
                                </tr>
                                @else
                                <tr>
