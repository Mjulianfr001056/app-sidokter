        ...
        <div class="w-full max-w-4xl bg-white shadow-lg rounded-lg p-6">
            ...
            <form method="POST">
                ...
                <div class="pb-4">
                    ...
                    <input type="text" id="tanggal_mulai" name="tanggal_mulai" value="{{ old('tanggal_mulai', $kegiatan->tanggal_mulai->format('d-m-Y')) }}" disabled
                           class="text-gray-600 mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-100 cursor-not-allowed">
                </div>
                ...
                <!-- Edit Button -->
                <div class="pb-4">
                    <a href="{{ route('edit-kegiatan', $kegiatan->id) }}"
